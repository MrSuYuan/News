                    ...
                    <div>
                        <table style="font-size: 14px">
                            <tr height = "50">
                                ...
                                <td width="300"><input type="text" size="35" id="type" name="type" placeholder="按现有上游顺序编号"><font color="red">&nbsp;&nbsp;*</font></td>
                            </tr>
                            <tr height = "50">
                                <td align = "right">名称:&nbsp;&nbsp;</td>
                                <td width="300"><input type="text" size="35" id="name" name="name" placeholder="上游名称"><font color="red">&nbsp;&nbsp;*</font></td>
                            </tr>
                            <tr height = "50">
                                <td align = "right">简称:&nbsp;&nbsp;</td>
                                <td width="300"><input type="text" size="35" id="shortName" name="shortName" placeholder="英文首字母简写"><font color="red">&nbsp;&nbsp;*</font></td>
                                </td>
                            </tr>
                            <tr height = "50">
                                <td></td>
                                <td>
                                    <input type="button" id="send" value="确定" onclick="create()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<!-- 加载预加载部分,头部和左导航栏 -->
<script type="text/javascript">
    loading("appUpstreamAdd", $('#userName').val());
        ...
        if(""==type || ""==name || ""==shortName){
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.code == 200){
                        alert(data.message);
                        window.location = path + "/appUpstreamList";
