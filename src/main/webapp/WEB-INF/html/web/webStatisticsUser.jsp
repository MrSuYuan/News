            ...
            <div class="page-content">
                <form action="#" method="post">
                    ...
                    <div align="center">
                        ...
                        <a class="btn btn-primary btn-xs" onclick="webStatisticsUser($('#currentPage').val())">
...
<!-- 加载预加载部分,头部和左导航栏 -->
<script type="text/javascript">
    loading("webStatisticsUser", $('#userName').val());
    ...
    //点击搜索数据展示
    function webStatisticsUser(currentPage) {
        ...
        $.ajax({
            url: path + "/web/webStatisticsUser",
            type: "post",
            data: {
