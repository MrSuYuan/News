        ...
        target.getChildNodes = function (data, parentNode, parentIndex, tbody) {
            $.each(data, function (i, item) {
                ...
                if (item[options.parentColumn] == parentNode[options.id]) {
                	var tr = $('<tr></tr>');
                    tr.attr("menu_id",item[options.id]);
//                    var nowParentIndex = (parentIndex + (++j));
                    ...
                    $.each(options.columns, function (index, column) {
                        ...
                        if(column.method){
                        	var htmlStr="";
                        	if(item[column.method]){
                        	    htmlStr="<input type='checkbox' id='"+item[column.method]+"' erp_tag='"+index+"'  value='"+item[column.method]+"' name='power_group_auth_ck'></input>"
                        	}
                        	td.html(htmlStr);
                            tr.append(td);
                        }else{
