...
public class WebController extends BaseController {
    ...
    @CrossOrigin
    public ReqResponse createAdspace(Long webId, int terminal, String spaceName, int spaceType, String remark, int width, int height) {
        ReqResponse req = new ReqResponse();
        Object userId = request.getSession().getAttribute("userId");
        if(null == userId){
            req.setCode(ErrorMessage.INVALID_LOGIN.getCode());
            ...
            req = webService.createAdspace((Long)userId, webId, terminal, spaceName, spaceType, remark, width, height);
        }
        return req;
    }
